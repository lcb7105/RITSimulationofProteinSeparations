        ...
        <div>
            ...
            <section className="pastTeamMembers">
                ...
                <div>
                    <h3>Amr Mualla</h3>
                    <ul>
                        <li>RIT Email: am3576@rit.edu</li>
                ...
                <div>
                    <h3>Beck Anderson</h3>
                    <ul>
                        <li>RIT Email: bea1935@rit.edu</li>
                ...
                <div>
                    <h3>Chase Amador</h3>
                    <ul>
                        <li>RIT Email: cma6320@rit.edu</li>
                ...
                <div>
                    <h3>Landon Heatly</h3>
                    <ul>
                        <li>RIT Email: lbh1442@rit.edu</li>
                        <li>Phone: <a href="tel:+12038329841" title="Click to call Landon if you're on your phone">+12038329841</a></li>
                    </ul>
                </div>
                ...
                <div>
                    <h3>Mack Leonard</h3>
                    <ul>
                        <li>RIT Email: mml2034@rit.edu</li>
